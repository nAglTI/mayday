package org.debs.kalpn.core.vpn.service
...
import org.debs.kalpn.core.gomobile.bridge.VpnCoreConfigEncoder
import org.debs.kalpn.core.gomobile.bridge.VpnCoreLaunchRequest
...
import org.debs.kalpn.core.vpn.controller.VpnConnectionStateStore
import org.debs.kalpn.core.vpn.notification.VpnNotificationFactory
...
class VpnCoreService : VpnService() {
    ...
    companion object {
        ...
        private const val ACTION_START = "org.debs.kalpn.action.START_VPN"
        private const val ACTION_STOP = "org.debs.kalpn.action.STOP_VPN"
